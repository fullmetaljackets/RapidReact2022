...
private final XboxController xboxDriver = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("TopShooter_Run: Shoot_Value", new TopShooter_Run(.75, m_shooter));
    SmartDashboard.putData("TopShooter_Run: ReverseShoot_Value", new TopShooter_Run(.75, m_shooter));
...
driver_Button_B.whileHeld(new TopShooter_Run(-.75, m_shooter) ,true);
    SmartDashboard.putData("Driver_Button_B",new TopShooter_Run(-.75, m_shooter) );

final JoystickButton driver_Button_A = new JoystickButton(xboxDriver, XboxController.Button.kA.value);        
driver_Button_A.whileHeld(new TopShooter_Run(.75, m_shooter) ,true);
    SmartDashboard.putData("Driver_Button_A",new TopShooter_Run(.75, m_shooter) );
